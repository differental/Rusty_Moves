...
pub struct TTTGameState {
    board: [[TTTBlockState; BOARD_SIZE as usize]; BOARD_SIZE as usize],
}

impl TTTGameState {
    pub fn new() -> TTTGameState {
        TTTGameState {
            board: [[TTTBlockState::Empty; BOARD_SIZE as usize]; BOARD_SIZE as usize],
        }
    }
}
...
impl TryFrom<String> for TTTGameState {
    ...
    fn try_from(str: String) -> Result<Self, Self::Error> {
        ...
        let mut board = [[TTTBlockState::Empty; BOARD_SIZE as usize]; BOARD_SIZE as usize];

        for i in 0..BOARD_SIZE as usize {
            for j in 0usize..BOARD_SIZE as usize {
                board[i][j] = blocks[BOARD_SIZE as usize * i + j];
            }
        }
